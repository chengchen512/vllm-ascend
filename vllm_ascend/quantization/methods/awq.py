...
class AscendAWQFusedMoEMethod(FusedMoEMethodBase):
    ...
    def _apply_ascend_moe(self, layer: torch.nn.Module, *args, **kwargs) -> torch.Tensor:
        # v0.18.0 already has the native W4A16 fused-MoE implementation,
        # but it predates the standalone helper used by the 0.22 AWQ branch.
        # Reuse that implementation directly and normalize the renamed
